const About = () => {
  return <section className="py-20 px-6 bg-secondary">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-lg md:text-xl text-secondary-foreground/90 mb-8 leading-relaxed">SW*AID is a community for women working in (or curious about) the fields of artificial intelligence and data. Based across the South West of England and Wales, we create spaces to connect, share knowledge, and support one another.</p>
